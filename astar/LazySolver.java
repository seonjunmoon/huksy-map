...
/**
 * Very basic syntactically correct but semantically incorrect shortest paths
 * solver. It tries the first edge it sees, and if that edge doesn't work it
 * gives up and (incorrectly) says the task is UNSOLVABLE.
 */
